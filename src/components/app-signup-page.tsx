  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      const response = await axios.post("http://localhost:3000/signup", {
        ...
        password,
        confirmPassword,
        name, // Include optional name
        profilePicture, // Include optional profile picture
      });
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                />
                <Link
                  href="https://darshmashru.com"
                  className="ml-2 block text-sm text-blue-600 hover:underline"
                >
